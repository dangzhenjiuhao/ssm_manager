...
<body class="childrenBody">
	<form class="layui-form" style="width:80%;">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input mobile" lay-verify="required" placeholder="请输入手机号码">
			</div>
		</div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/pagejs/user/addUser.js"></script>
</body>
</html>