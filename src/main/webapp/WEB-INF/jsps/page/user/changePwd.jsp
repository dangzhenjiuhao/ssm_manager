...
<body class="childrenBody">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/pagejs/user/address.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/pagejs/user/user.js"></script>
</body>
</html>